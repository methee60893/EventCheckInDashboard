...
namespace EventCheckInDashboard.Pages
{
    ...
    public class ThepowerpusherModel : PageModel
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<ThepowerpusherModel> _logger;
        ...
        public ThepowerpusherModel(IConfiguration configuration, ILogger<ThepowerpusherModel> logger)
        {
        ...
        public async Task OnGetAsync()
        {
            ...
            {
                _logger.LogError(ex, "An error occurred while fetching Thepowerpusher dashboard data.");
                ErrorMessage = "เกิดข้อผิดพลาดในการดึงข้อมูลสำหรับหน้า The Power Pusher";
            }
        }
